...
public class DataProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI_MESSAGES = Uri.parse("content://com.toxablack.chat.provider/messages");
	public static final Uri CONTENT_URI_PROFILE = Uri.parse("content://com.toxablack.chat.provider/profile");
	...
	static {
		...
		uriMatcher.addURI("com.toxablack.chat.provider", "messages", MESSAGES_ALLROWS);
		uriMatcher.addURI("com.toxablack.chat.provider", "messages/#", MESSAGES_SINGLE_ROW);
		uriMatcher.addURI("com.toxablack.chat.provider", "profile", PROFILE_ALLROWS);
		uriMatcher.addURI("com.toxablack.chat.provider", "profile/#", PROFILE_SINGLE_ROW);
	}
